    ...
    ios: {
      ...
      infoPlist: {
        ...
        NSUserNotificationsUsageDescription:
          "Temple TV uses notifications to alert you when a live broadcast or new sermon is available.",
        NSPhotoLibraryUsageDescription:
          "Temple TV needs access to your photo library so you can choose a profile picture.",
        NSPhotoLibraryAddUsageDescription:
          "Temple TV can save shared content (such as broadcast images) to your photo library.",
      },
    },
    android: {
