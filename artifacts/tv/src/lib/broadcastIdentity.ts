...
/** Hero headline shown on the live landing — replaces the dynamic
 *  `liveStatus.title` so the hero reads as a station identity, not a
 *  sermon-specific landing. */
export const BROADCAST_HERO_TITLE = "Temple TV Live Stream";
