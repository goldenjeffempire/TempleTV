  ...
  r.post(
    "/",
    {
      ...
      config: { rateLimit: { max: 30, timeWindow: "1 minute" } },      schema: {
        ...
        response: { 201: MediaItemSchema, 429: z.object({ error: z.string() }) },
        security: [{ bearerAuth: [] }],
      },
    },
    async (req, reply) => {
  ...
  r.patch(
    "/:id",
    {
      ...
      config: { rateLimit: { max: 30, timeWindow: "1 minute" } },      schema: {
        ...
        response: { 200: MediaItemSchema, 429: z.object({ error: z.string() }) },
        security: [{ bearerAuth: [] }],
      },
    },
  ...
  r.post(
    "/uploads/signed-url",
    {
      ...
      config: { rateLimit: { max: 20, timeWindow: "1 minute" } },      schema: {
        ...
        response: { 200: SignedUploadResponseSchema, 429: z.object({ error: z.string() }) },
        security: [{ bearerAuth: [] }],
      },
    },
