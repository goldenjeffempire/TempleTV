...
> Apple requires **at least 3** and accepts up to **10**. We provide 3.
...
> Optional but improves Play Store ranking for tablet form factors.
...
| Apple App Store — iPad 13″ | 3 | ✅ Meets minimum (3) |
| Google Play — Phone | 6 | ✅ Exceeds minimum (2) |
| Google Play — 10″ Tablet | 2 | ✅ Optional, included |
| Smart TV — 1080p | 3 | ✅ |
...
- **Login/Signup** screens are not included since most apps lead with their
  hero/content screens. If you would like login screens, add them to the
  re-capture list.
